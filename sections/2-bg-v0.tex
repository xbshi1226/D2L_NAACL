...
This paper studies context parameterization under continual updates, where contextual information is internalized into a parameterized state for reuse across queries. Let $C$, $q$, and $y$ denote the context, query, and answer sequences, respectively, and let $p_\theta$ denote the conditional generation distribution of a language model with parameters $\theta$.
