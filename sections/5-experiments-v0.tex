...
Locality evaluates whether the model preserves answers to queries outside the scope of the update, thereby measuring interference with retained information. \method{} achieved strong Locality among parameterized methods, outperforming D2L and CD by 10.25 and 20.30 points, respectively, as shown in Figure~\ref{fig:locality}. This result indicates that \method{} more effectively limits interference introduced by parameter updates while retaining the established context state.
